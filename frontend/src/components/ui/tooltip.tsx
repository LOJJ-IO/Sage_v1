    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            isCompact
              ? "z-50 w-fit max-w-xs rounded-md border-none bg-black px-2.5 py-1.5 text-[12px] font-semibold leading-none text-white shadow-md data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0"
